 ...
 */
function discoveryGeocode(platform, at) {
...
function createUIforDropdown() {
  ...
  subTitle.innerHTML= "<p>This example shows 100 hotels within 10 miles radius of below cities</p>";
  ...
  function eventCities(){
    ...
    discoveryGeocode(platform, cities[citiesIndex].position)
  }
...
discoveryGeocode(platform, "45.52,-122.68");
createUIforDropdown();
